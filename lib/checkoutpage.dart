...
class check_out extends State<Checkout> {
  ...
  //   Item(itemName: 'Black Grape', itemQun: 'Qty:1', itemPrice: 'Rs: 100'),
  //   Item(itemName: 'Tomato', itemQun: 'Qty:3', itemPrice: 'Rs: 90'),
  //   Item(itemName: 'Mango', itemQun: 'Qty:2', itemPrice: 'Rs: 105'),
  //   Item(itemName: 'Lemon', itemQun: 'Qty:2', itemPrice: 'Rs: 20'),
  //   Item(itemName: 'Apple', itemQun: 'Qty:1', itemPrice: 'Rs: 50'),
  // ];
                              ...
                              children: <Widget>[
                                ...
                                Text(itemList[ind].itemQun.toString(),
                                    style: TextStyle(
                                        ...
                                        color: Colors.black87,
                                        fontWeight: FontWeight.bold)),
                                Text(itemList[ind].finalPrice.toString(),
                                    style: TextStyle(
                                        fontSize: 16.0,
                                        color: Colors.black87,
                                        fontWeight: FontWeight.bold)),
